package com.github.Gunosy.digdag.plugin.athena.aws.glue


import com.amazonaws.services.glue.{AWSGlue, AWSGlueClientBuilder}
import com.github.Gunosy.digdag.plugin.athena.aws.{Aws, AwsService}
import com.github.Gunosy.digdag.plugin.athena.aws.glue.catalog.{DatabaseCatalog, PartitionCatalog, TableCatalog}
